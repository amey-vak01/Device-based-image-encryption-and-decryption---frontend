...
import './App.css';
import 'axios';// Axios has function names that match any HTTP methods. To perform a GET request, you use the .get() method.
...
//By making a request, we expect the  API to perform an operation according to the request  made.
function App() {
